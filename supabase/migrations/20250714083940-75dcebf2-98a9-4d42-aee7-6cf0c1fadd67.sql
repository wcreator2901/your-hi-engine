-- Create missing wallet data for user 61b5f835-bb5b-4158-9a1d-804c9b741eb2 (handle duplicates)
...
-- Create matching deposit addresses (handle duplicates)
...
ON CONFLICT (user_id, asset_symbol, network) DO NOTHING;
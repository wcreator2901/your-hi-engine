...
export const TempAddressCalculator = () => {
  const [addresses, setAddresses] = useState<any>(null);
  
  useEffect(() => {
    const testMnemonic = "deputy odor heart sugar apple hub danger exact century horn cry believe";
    
    console.log('=== Calculating addresses for new user seed ===');
    ...
    try {
      ...
      console.log('New user ETH Address:', results.eth);
  ...
  return (
    <div className="p-4 bg-card rounded-lg">
      <h3 className="text-lg font-semibold mb-3">New User Addresses:</h3>
